...
using QueryInterceptor.Core.ConsoleApp.net48.Database;

namespace QueryInterceptor.Core.ConsoleApp.net48;
...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Hello QueryInterceptor.Core.ConsoleApp.net48");
