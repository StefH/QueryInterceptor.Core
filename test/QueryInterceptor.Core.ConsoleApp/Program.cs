...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        {
            context.Cars.Add(new Car { Brand = "Ford", Color = "Blue", Vin = "?", Year = "1999" });
            context.Cars.Add(new Car { Brand = "Fiat", Color = "Red", Vin = "?", Year = "1960" });
            context.Cars.Add(new Car { Brand = "Alfa", Color = "Black", Vin = "?", Year = "2000" });
            context.SaveChanges();
        }
